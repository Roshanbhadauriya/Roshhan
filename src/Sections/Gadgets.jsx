      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        {gadgetsData.map((gadget, index) => (
          <motion.div 
            ...
            className={`w-full flex flex-col-reverse md:flex-row bg-[#1c1c1c] rounded-2xl overflow-hidden mb-16  border border-white/5`}
          >
            {/* Context Column */}
            ...
            <div className="w-full md:w-7/12 bg-[#252525] p-12 md:p-20 flex justify-center items-center">
               <img 
                 src={gadget.image} 
                 alt={gadget.title} 
                 className="w-full  object-contain hover:scale-105 transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)]" 
